...
int main (void) {
  ...
  stm32_Init ();                                // STM32 setup
	...
	//OUTPUT PA8
//	*(volatile unsigned int *) (0x40021018) |= 0x04; //APB2ENR => CLOCK
//	*(volatile unsigned int *) (0x40010800) |= 0x40; //GPIO->CRL
//	*(volatile unsigned int *) (0x40010804) |= 0x03; //GPIO->CRH
//	
...
//	*(volatile unsigned int *) (0XE000E100) |= 0x80; //NVIC->ISER0
	...
	*(volatile unsigned int *) (0x40021018) |= 0x1C; //APB2ENR => CLOCK
	...
	*(volatile unsigned int *) (0XE000E100) |= 0x00800000; //NVIC->ISER0
